// Smart Modal - Simple Homepage Redirect
(function() {
    const CONFIG = {
        progressDuration: 5000, // Progress bar duration
    };
    ...
    // Initialize
    function init() {
        // Check if modal was already shown before (stored permanently)
        ...
        function animateProgress() {
            ...
            const timer = setInterval(() => {
                ...
                if (progress >= 100) {
                    ...
                    setTimeout(() => popupButtons.classList.add('active'), 300);
                } else {
        ...
        function closePopup() {
            // Remember that modal was shown (permanently)
        ...
        // Continue button - Go to site homepage (index.html)
        continueBtn.addEventListener('click', () => {
            // Remember that modal was shown (permanently)
            sessionStorage.setItem('modalShown', 'true');
            
            // Redirect to index.html explicitly
            const homepage = window.location.origin + window.location.pathname.substring(0, window.location.pathname.lastIndexOf('/') + 1);
